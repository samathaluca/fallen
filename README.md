...
Within the main page the story cards link to a details story . one story per page. The main content of the page is the data stored in MongoDB which is pulled in to the grid.
- forms
1. A second page containing a simple collapsible form for the user to complete their story with prompted questions and a selction of answers.
2. A third page containing a list of contributor's recoverys stories
3. A third page form at add contributor recovery stories.
4. 
